...
#img_folder = '/home/mengmi/Projects/Proj_context1/Datasets/MSCOCO/trainColor_img/'
#bin_folder = '/home/mengmi/Projects/Proj_context1/Datasets/MSCOCO/trainColor_binimg/'
txt_folder = '../Datalist/' #replace with your own directory as above
img_folder = '../Datasets/MSCOCO/trainColor_img/' #replace with your own directory as above
bin_folder = '../Datasets/MSCOCO/trainColor_binimg/' #replace with your own directory as above
split = 'train'
...
vocab_size = 80 # number of output categories
...
alpha_c = 2.  # regularization parameter for 'doubly stochastic attention', as in the paper; default: 1.0
...
def train(train_loader, encoder, decoder, transform, criterion, encoder_optimizer, decoder_optimizer, epoch):
    ...
    # Batches
    for i, (imgs, binimgs, blurs, labels) in enumerate(train_loader):
        #print (i)
        ...
        # forward everything
        scores, alphas, _ = decoder(encoder, transform, imgs, blurs, binimgs, click_steps, batch_size, imgsz, ClickRadius)
        #print('scores')
        #print(scores)
        #print('alphas')
        #print(alphas.shape)
